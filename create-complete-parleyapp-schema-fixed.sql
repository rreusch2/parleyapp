-- Complete ParleyApp Database Schema - SAFE VERSION
-- This version handles existing objects gracefully

-- ==============================================
-- HELPER: Drop existing triggers safely
-- ==============================================
DO $$
BEGIN
...
-- ==============================================
-- INDEXES for Performance (CREATE IF NOT EXISTS equivalent)
-- ==============================================
DO $$
BEGIN
...
-- Create all triggers fresh (we dropped them at the top)
...
DO $$
BEGIN
    RAISE NOTICE '🎉 ParleyApp database schema setup completed successfully!';
    RAISE NOTICE '✅ All tables created';
    RAISE NOTICE '✅ All indexes created';
    RAISE NOTICE '✅ All security policies applied';
    RAISE NOTICE '✅ All triggers configured';
    RAISE NOTICE '✅ Helper functions installed';
    RAISE NOTICE '';
    RAISE NOTICE '🚀 Your ParleyApp now has full data persistence!';
END $$; 